...
texts = {
    "fr":{
        ...
        "timeout_choose_faster": (
            "Temps écoulé, réagissez plus vite la prochaine fois, {user}."
        ),
        ...
        "max_bullies_reached": "Vous ne pouvez pas avoir plus de {max_bullies} bullies !",
        "new_bully_msg": "Nouveau bully : {name}",
        "choose_bully": "{user}, choisissez un bully :",
        "selected_bully": "{user} a sélectionné {name}",
        "choose_fighter": "{user}, choisissez votre combattant :",
        "selected_fighter": "{user} sélectionne {name}.",
        "choose_suicide": "{user}, choisissez un bully à sacrifier :",
        "suicide_kill": "{user} tue {name}",
        ...
        "lootbox_max_bullies": "{user}, vous ne pouvez pas avoir plus de {max_bullies} bullies en même temps",
        "lootbox_purchase_success": "{user} a acheté une lootbox et a obtenu... {name} un {rarity}!",

        #reserve
        "reserve_bullies_info": "{user}, vos bullies en réserve :",
        "reserve_max_bullies": "Vous ne pouvez pas avoir plus de {max_reserve} bullies !",
        "new_bully_reserve": "Vous avez un nouveau bully en réserve : {name}",
    ...
    "en":{
        ...
        "new_bully_msg": "New bully: {name}",
        "choose_bully": "{user}, choose a bully:",
        "selected_bully": "{user} selects {name}",
        "choose_fighter": "{user}, choose your fighter:",
        "selected_fighter": "{user} selects {name}.",
        "choose_suicide": "{user}, choose a bully to sacrifice:",
        "suicide_kill": "{user} kills {name}",
        ...
        "lootbox_max_bullies": "{user}, you can't have more than {max_bullies} bullies at the same time",
        "lootbox_purchase_success": "{user} has purchased a lootbox and got... {name} a {rarity}!",

        #reserve
        "reserve_bullies_info": "{user}, your bullies in reserve:",
        "reserve_max_bullies": "You cannot have more than {max_reserve} bullies!",
        "new_bully_reserve": "You have a new bully in reserve: {name}",
